...
class TPVVShortcode_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'tpvv-shortcode'));
        }
        ...
        <div class="wrap">
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'tpvv-shortcode'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'tpvv-shortcode') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function createFormControl($aOptionKey, $aOptionMeta, $savedOptionValue) {
        if (is_array($aOptionMeta) && count($aOptionMeta) >= 2) { // Drop-down list
            ...
            ?>
            <input type="text" name="<?php echo $aOptionKey ?>" id="<?php echo $aOptionKey ?>" value="<?php echo esc_attr($savedOptionValue) ?>" size="50"/>
            <?php
        }
    }
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'tpvv-shortcode');
            case 'false':
                return __('false', 'tpvv-shortcode');

            case 'Administrator':
                return __('Administrator', 'tpvv-shortcode');
            case 'Editor':
                return __('Editor', 'tpvv-shortcode');
            case 'Author':
                return __('Author', 'tpvv-shortcode');
            case 'Contributor':
                return __('Contributor', 'tpvv-shortcode');
            case 'Subscriber':
                return __('Subscriber', 'tpvv-shortcode');
            case 'Anyone':
                return __('Anyone', 'tpvv-shortcode');
        }
        return $optionValue;
    }
